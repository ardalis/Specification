...
public class Benchmark3_DbQuery
{
     ...
     * 5 -> Where, Order chain, Include chain, Like, Skip, Take, Flag (AsNoTracking)
        ...
        | Method | Type | Mean     | Error    | StdDev   | Median   | Ratio | RatioSD | Gen0    | Gen1   | Allocated | Alloc Ratio |
        |------- |----- |---------:|---------:|---------:|---------:|------:|--------:|--------:|-------:|----------:|------------:|
        | EFCore | 0    | 301.2 us | 12.46 us | 36.16 us | 316.8 us |  1.02 |    0.20 | 10.7422 | 0.9766 |  91.46 KB |        1.00 |
        | Spec   | 0    | 288.0 us | 14.10 us | 40.47 us | 308.8 us |  0.97 |    0.20 | 10.7422 | 0.9766 |   91.6 KB |        1.00 |
        |        |      |          |          |          |          |       |         |         |        |           |             |
        | EFCore | 1    | 302.6 us | 12.69 us | 36.60 us | 318.6 us |  1.02 |    0.20 | 10.7422 | 0.9766 |     94 KB |        1.00 |
        | Spec   | 1    | 305.0 us | 12.78 us | 36.05 us | 321.1 us |  1.03 |    0.20 | 10.7422 | 0.9766 |  94.18 KB |        1.00 |
        |        |      |          |          |          |          |       |         |         |        |           |             |
        | EFCore | 2    | 311.6 us | 12.02 us | 34.67 us | 326.3 us |  1.02 |    0.18 | 11.7188 | 0.9766 |  95.82 KB |        1.00 |
        | Spec   | 2    | 312.0 us | 11.68 us | 33.71 us | 327.1 us |  1.02 |    0.18 | 11.7188 | 0.9766 |  96.12 KB |        1.00 |
        |        |      |          |          |          |          |       |         |         |        |           |             |
        | EFCore | 3    | 328.9 us | 12.78 us | 35.42 us | 344.2 us |  1.01 |    0.18 | 11.7188 | 0.9766 | 100.95 KB |        1.00 |
        | Spec   | 3    | 348.4 us |  3.73 us |  3.11 us | 347.9 us |  1.07 |    0.15 | 11.7188 | 0.9766 | 101.25 KB |        1.00 |
        |        |      |          |          |          |          |       |         |         |        |           |             |
        | EFCore | 4    | 347.4 us |  5.76 us |  5.39 us | 346.3 us |  1.00 |    0.02 | 12.6953 | 0.9766 |  103.7 KB |        1.00 |
        | Spec   | 4    | 347.5 us |  1.15 us |  1.13 us | 347.5 us |  1.00 |    0.01 | 12.6953 | 0.9766 |  104.3 KB |        1.01 |
        |        |      |          |          |          |          |       |         |         |        |           |             |
        | EFCore | 5    | 397.7 us |  1.64 us |  1.37 us | 397.9 us |  1.00 |    0.00 | 14.6484 | 0.9766 | 121.77 KB |        1.00 |
        | Spec   | 5    | 401.7 us |  1.15 us |  0.96 us | 401.6 us |  1.01 |    0.00 | 14.6484 | 0.9766 | 122.28 KB |        1.00 |
     */
